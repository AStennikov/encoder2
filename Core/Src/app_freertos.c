...
/* Definitions for main_loop */
osThreadId_t main_loopHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* creation of main_loop */
  main_loopHandle = osThreadNew(threadPID_Loop, NULL, &main_loop_attributes);

  /* creation of green_led */
  green_ledHandle = osThreadNew(threadGreenLED, NULL, &green_led_attributes);
...
/**
  * @brief  Function implementing the main_loop thread.
